...
<div class="space-y-8">
        ...
        <div class="bg-gradient-to-r from-orange-600 to-orange-700 px-8 py-6">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-orange-100 text-sm">Update your personal details and account settings</p>
                </div>
            </div>
        </div>

        <form method="POST" action="{{ route('plebo.profile.update') }}" class="p-8">
            @csrf
            @method('PATCH')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 @error('fname') border-red-500 @enderror"
                               required>
                        @error('fname')
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 @error('lname') border-red-500 @enderror"
                               required>
                        @error('lname')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
            ...
            <div class="mb-8 pt-8 border-t border-gray-200">
                <h3 class="text-lg font-bold text-gray-900 mb-4 flex items-center">
                    <i class="fas fa-address-book mr-2 text-orange-600"></i>
                    Contact Information
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Email -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="password" 
                               name="new_password" 
                               id="new_password" 
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 @error('new_password') border-red-500 @enderror"
            ...
            <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                ...
                <button type="submit" 
                        class="px-6 py-3 bg-orange-600 hover:bg-orange-700 text-white rounded-lg font-medium transition-colors duration-200">
    ...
    <div class="content-card rounded-xl overflow-hidden shadow-lg border border-gray-200">
        ...
        <div class="p-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Role -->
                <div class="flex items-center space-x-3 p-4 bg-orange-50 rounded-lg border border-orange-100">
                    <div class="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center">
                        <i class="fas fa-vial text-orange-600 text-xl"></i>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600">Role</p>
                        <p class="text-lg font-bold text-gray-900">Medical Phlebotomist</p>
                    </div>
                </div>
