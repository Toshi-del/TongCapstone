...
@section('title', 'Radtech Messages')
@section('page-title', 'Radtech Messages')

@section('content')
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-cyan-50 to-blue-50 p-6">
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Radtech Messages</h1>
                ...
                <div class="chat-sidebar">
                    ...
                    <div class="chat-search">
                        <div class="relative">
                            ...
                            <input id="user-search" type="text" class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-150" placeholder="Search users..." autocomplete="off">
                        </div>
                    </div>
                ...
                <div class="chat-main">
                        ...
                        <div class="chat-empty" id="chat-empty">
                            <div class="text-center py-12">
                                <div class="w-16 h-16 bg-cyan-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                                    <i class="fas fa-comment-dots text-cyan-600 text-2xl"></i>
                                </div>
                    ...
                    <form id="chat-form" class="chat-input" autocomplete="off">
                        ...
                        <div class="flex items-end space-x-3">
                            ...
                            <button type="submit" class="inline-flex items-center px-4 py-3 bg-cyan-600 hover:bg-cyan-700 text-white rounded-xl font-medium transition-all duration-150 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed" id="send-btn" disabled>
...
<script>
	...
	function loadMessages(forceScroll) {
		...
		fetch(`/radtech/messages/fetch?user_id=${requestUserId}`)
			.then(response => {
				if (!response.ok) {
	...
	function showNotification(message) {
		if (Notification.permission === 'granted') {
			new Notification('Radtech Messages', {
				body: message,
				icon: '/favicon.ico'
			});
	...
	function markAsRead() {
		if (!selectedUserId) return;
		fetch('/radtech/messages/mark-read', {
			method: 'POST',
			headers: {
				'Content-Type': 'application/json',
				'X-CSRF-TOKEN': '{{ csrf_token() }}'
