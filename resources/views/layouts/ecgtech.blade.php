...
<head>
    ...
    <title>@yield('title', 'ECG Technician Dashboard - RSS Citi Health Services')</title>
...
<body class="h-full bg-gray-900">
        ...
        <div class="w-72 glass-sidebar relative z-10 shadow-2xl flex flex-col h-full">
            ...
            <div class="p-8 border-b border-gray-200 flex-shrink-0">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-gray-900">ECG Technician</h1>
            ...
            <nav class="flex-1 px-6 py-8 space-y-2 overflow-y-auto">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-1">
                        <a href="{{ route('ecgtech.dashboard') }}" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 {{ request()->routeIs('ecgtech.dashboard') ? 'active text-white' : '' }}">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-1">
                        <a href="{{ route('ecgtech.pre-employment') }}" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 {{ request()->routeIs('ecgtech.pre-employment*') ? 'active text-white' : '' }}">
                            <i class="fas fa-briefcase mr-4 text-lg"></i>
                            <span class="font-medium">Pre-Employment</span>
                        </a>
                        <a href="{{ route('ecgtech.annual-physical') }}" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 {{ request()->routeIs('ecgtech.annual-physical*') ? 'active text-white' : '' }}">
                            <i class="fas fa-heartbeat mr-4 text-lg"></i>
                            <span class="font-medium">Annual Physical</span>
                        </a>
                        <a href="{{ route('ecgtech.opd') }}" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 {{ request()->routeIs('ecgtech.opd*') ? 'active text-white' : '' }}">
            ...
            <div class="flex-shrink-0 p-6 border-t border-gray-200 mt-auto">
                <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                    <div class="flex items-center space-x-3">
                        <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center text-white font-bold text-lg shadow-lg">
                            {{ substr(Auth::user()->fname ?? 'E', 0, 1) }}
                        </div>
                        <div class="flex-1 min-w-0">
                            <p class="text-gray-900 font-semibold text-sm truncate">
                                {{ Auth::user()->fname ?? 'ECG' }} {{ Auth::user()->lname ?? 'Tech' }}
                            </p>
                            <p class="text-gray-600 text-xs">ECG Technician</p>
                        </div>
            ...
            <header class="content-card shadow-lg border-b border-gray-200 relative z-20">
                <div class="flex items-center justify-between px-8 py-6">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">@yield('page-description', 'ECG Technician Portal')</p>
                    </div>
    ...
    <div id="profileModal" class="fixed inset-0 bg-black bg-opacity-50 overflow-y-auto h-full w-full hidden z-50 flex items-center justify-center">
        <div class="relative mx-auto p-0 border-0 w-full max-w-md shadow-2xl rounded-2xl bg-white">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-green-100 text-sm">ECG Technician</p>
                        </div>
                    </div>
            ...
            <div class="p-8">
                <!-- Profile Info -->
                <div class="flex items-center space-x-4 mb-8 p-4 bg-green-50 rounded-xl border border-green-100">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center space-x-2 mt-1">
                            <span class="px-2 py-1 bg-green-100 text-green-700 text-xs font-medium rounded-full">ECG Technician</span>
                ...
                <!-- Menu Items -->
                <div class="space-y-2">
                    <a href="#" class="flex items-center px-4 py-3 text-gray-700 hover:bg-green-50 hover:text-green-700 rounded-xl transition-all duration-200 group">
                        <div class="w-10 h-10 bg-gray-100 group-hover:bg-green-100 rounded-lg flex items-center justify-center mr-3 transition-colors">
                            <i class="fas fa-user-edit text-gray-500 group-hover:text-green-600"></i>
                        </div>
                        <span class="font-medium">Edit Profile</span>
                        <i class="fas fa-chevron-right ml-auto text-gray-400 group-hover:text-green-500"></i>
                    </a>
                    <a href="#" class="flex items-center px-4 py-3 text-gray-700 hover:bg-green-50 hover:text-green-700 rounded-xl transition-all duration-200 group">
                        <div class="w-10 h-10 bg-gray-100 group-hover:bg-green-100 rounded-lg flex items-center justify-center mr-3 transition-colors">
                            <i class="fas fa-cog text-gray-500 group-hover:text-green-600"></i>
                        </div>
                    ...
                    <a href="#" class="flex items-center px-4 py-3 text-gray-700 hover:bg-green-50 hover:text-green-700 rounded-xl transition-all duration-200 group">
                        <div class="w-10 h-10 bg-gray-100 group-hover:bg-green-100 rounded-lg flex items-center justify-center mr-3 transition-colors">
                            <i class="fas fa-question-circle text-gray-500 group-hover:text-green-600"></i>
                        </div>
