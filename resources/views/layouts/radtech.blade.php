            ...
            <nav class="flex-1 px-6 py-8 space-y-2 overflow-y-auto">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-1">
                        ...
                        <a href="{{ route('radtech.opd.xray') }}" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 {{ request()->routeIs('radtech.opd.xray*') ? 'active text-white' : '' }}">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-1">
                        <a href="{{ route('radtech.messages') }}" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 {{ request()->routeIs('radtech.messages*') ? 'active text-white' : '' }}">
            ...
            <header class="content-card shadow-lg border-b border-gray-200 relative z-20">
                <div class="flex items-center justify-between px-8 py-6">
                    ...
                    <div class="flex items-center space-x-4">
                        <!-- Messages -->
                        <div class="relative">
                            <a href="{{ route('radtech.messages') }}" class="p-3 text-gray-600 hover:text-cyan-600 hover:bg-cyan-50 rounded-xl transition-all duration-200 inline-block">
                                <i class="fas fa-envelope text-lg"></i>
                                <span id="header-message-count" class="absolute -top-1 -right-1 w-3 h-3 bg-cyan-500 rounded-full notification-badge hidden"></span>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div id="profileModal" class="fixed inset-0 bg-black bg-opacity-50 overflow-y-auto h-full w-full hidden z-50 flex items-center justify-center">
        <div class="relative mx-auto p-0 border-0 w-full max-w-md shadow-2xl rounded-2xl bg-white">
            ...
            <div class="p-8">
                ...
                <!-- Menu Items -->
                <div class="space-y-2">
                    <a href="{{ route('radtech.profile.edit') }}" class="flex items-center px-4 py-3 text-gray-700 hover:bg-cyan-50 hover:text-cyan-700 rounded-xl transition-all duration-200 group">
