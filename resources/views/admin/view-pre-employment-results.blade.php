...
async function sendToBoth() {
    ...
    try {
        ...
        if (data.success) {
            showSuccessMessage('Pre-employment examination sent to both successfully!', 'The pre-employment examination results have been successfully transmitted to both the company and patient.');
            setTimeout(() => {
                window.location.href = '{{ route("admin.tests") }}';
            }, 2000);
        } else {
