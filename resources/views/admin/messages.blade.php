...
<script>
	...
	function loadMessages(forceScroll) {
		...
		fetch(`/admin/messages/fetch?user_id=${requestUserId}`)
	...
	document.getElementById('chat-form').addEventListener('submit', function(e) {
		...
		.finally(() => {
			console.log('Admin message send completed, restoring form state');
			...
			console.log('Admin form elements check:', {
				messageEl: !!messageEl,
				sendBtn: !!sendBtn,
				chatForm: !!chatForm,
	...
	document.addEventListener('DOMContentLoaded', function() {
		// Check form elements on page load
		const messageEl = document.getElementById('message');
		const sendBtn = document.getElementById('send-btn');
		const chatForm = document.getElementById('chat-form');
		
		console.log('Admin page loaded - form elements check:', {
			messageEl: !!messageEl,
			sendBtn: !!sendBtn,
			chatForm: !!chatForm
		});
		
		// Ensure form elements are visible and functional on load
		if (messageEl) {
			messageEl.style.display = '';
			messageEl.disabled = false;
			messageEl.readOnly = false;
