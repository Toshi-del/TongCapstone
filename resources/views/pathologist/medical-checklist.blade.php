...
<div class="max-w-7xl mx-auto space-y-8">
    ...
    <div class="mb-6">
        <a href="{{ route(
            (isset($examinationType) && ($examinationType === 'pre_employment' || $examinationType === 'pre-employment')) ? 'pathologist.pre-employment' : 
            ((isset($examinationType) && ($examinationType === 'annual_physical' || $examinationType === 'annual-physical')) ? 'pathologist.annual-physical' : 
            ((isset($examinationType) && $examinationType === 'opd') ? 'pathologist.opd' : 'pathologist.dashboard'))
        ) }}" 
                            ...
                            <div class="flex items-center space-x-6">
                                <div class="text-right">
                                    ...
                                    <input type="text" name="{{ $field }}_done_by"
                                           ...
                                           @if($field === 'stool_exam' || $field === 'urinalysis') 
                                               @if($field === 'stool_exam' || $field === 'urinalysis') required @endif
