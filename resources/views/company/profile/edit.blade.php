...
@section('page-description', 'Update your company account information and settings')
    ...
    <div class="bg-white rounded-xl overflow-hidden shadow-lg border border-gray-200">
        <div class="bg-gradient-to-r from-blue-600 to-blue-800 px-8 py-6">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-white">Company Profile</h2>
                    <p class="text-blue-100 text-sm">Update your company account details</p>
                </div>
            </div>
        </div>

        <form method="POST" action="{{ route('company.profile.update') }}" class="p-8">
            @csrf
            @method('PATCH')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('fname') border-red-500 @enderror"
                               required>
                        @error('fname')
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('lname') border-red-500 @enderror"
                               required>
                        @error('lname')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="flex items-center space-x-3 p-4 bg-blue-50 rounded-lg border border-blue-100">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900">Company Administrator</p>
                    </div>
                </div>
