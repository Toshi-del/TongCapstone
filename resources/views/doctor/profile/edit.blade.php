        ...
        <div class="bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-6">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-blue-100 text-sm">Update your personal details and account settings</p>
                </div>
            </div>
        </div>

        <form method="POST" action="{{ route('doctor.profile.update') }}" class="p-8">
            @csrf
            @method('PATCH')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="flex items-center space-x-3 p-4 bg-blue-50 rounded-lg border border-blue-100">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900">Medical Doctor</p>
                    </div>
                </div>
